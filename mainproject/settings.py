"""
Django settings for nuatthaiproject project.
...
ROOT_URLCONF = 'nuatthaiproject.urls'
...
WSGI_APPLICATION = 'nuatthaiproject.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'nuatthaiproject/static')
]
